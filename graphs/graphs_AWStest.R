...
#dataframe
weightDat<-offspring %>%
  select(Mage,MageC,BageC,Bage,Sage,SageC,lifespanB,lifespanS,lifespanB,lifespanM,Jincube,weight.age,pre1992,weight,EPb,
...
newdat<-new_data(weight,terms=c("Bage","mum[sample=100]","cohort[sample=15]",
              "dad_bio[sample=100]","dad_soc[sample=100]"),condition=c(WPb=1,EPb=0))
