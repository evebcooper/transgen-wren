...
tab_model(inde.all,indeEP,indeWP,transform=NULL,show.icc=FALSE,title = "Survival to Independence",
          dv.labels =c( "All offspring","Extra-pair offspring","Within-pair offspring"))
